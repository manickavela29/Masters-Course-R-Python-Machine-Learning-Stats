...
public class MapForWordCount2 extends Mapper<LongWritable,Text,IntWritable,Data>
{
    ...
    public void map(LongWritable key,Text value ,Context c) throws IOException,InterruptedException
    {
            ...
            c.write(one,new Data(new Text(words[0]),new IntWritable(Integer.parseInt(words[1]))));
    }
}