...
public class main11
{
    public static void main(String[] args) throws Exception
    {
        ...
        j4.setJarByClass(main11.class);
        j4.setJobName("Relational Algebra 4");
        j4.setMapperClass(Map4ForRA.class);
        j4.setMapOutputKeyClass(Text.class);
        j4.setMapOutputValueClass(Text.class);
        j4.setReducerClass(Reduce4ForRA.class);
        j4.setOutputKeyClass(Text.class);
        j4.setOutputValueClass(Text.class);
        FileInputFormat.addInputPath(j4,new Path(args[3]));
        FileOutputFormat.setOutputPath(j4,new Path(args[4]));
